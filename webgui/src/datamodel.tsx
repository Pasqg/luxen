...
export function issueWithStatus(issue: Issue, newStatus: string): Issue {
    return {project_id: issue.project_id, title: issue.title, description: issue.description, id: issue.id, status: newStatus};
}